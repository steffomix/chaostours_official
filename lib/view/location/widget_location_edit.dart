...
class _WidgetLocationEdit extends State<WidgetLocationEdit> {
  ...
  Widget scaffold(Widget body) {
    return AppWidgets.scaffold(context,
        ...
        navBar: BottomNavigationBar(
            ...
            onTap: (int id) async {
              if (id == 0) {
                Navigator.pushNamed(context, AppRoutes.osmLocation.route)
                    .then((_) {
                  render();
                });
              } else if (id == 1) {
    ...
    return ListView(children: [
      ...
      Container(
          ...
          child: Column(children: [
            ...
            ListTile(
                title: Container(
                    color: LocationPrivacy.normal.color,
            ...
            ListTile(
                title: Container(
                    color: LocationPrivacy.private.color,
                    padding: const EdgeInsets.all(3),
  ...
  void setStatus(LocationPrivacy? state) {
    _modelLocation?.privacy = (state ?? LocationPrivacy.private);
